...
export const HelpSection = () => {
  const tips = [
  "Upload sharp, well-lit photos that clearly showcase your item's condition and key details.",
  "Provide an accurate and detailed description, including specifications, history, and any imperfections.",
  "Choose a competitive starting bid to encourage early participation and attract more bidders.",
  "Set an auction duration of 3–7 days to maximize visibility while maintaining bidder interest.",
  "List your item in the most relevant category and add clear titles to improve discoverability.",
];

  return (
    <div className="mt-6 bg-amber-50/60 border border-amber-500 rounded-2xl p-5">
      <h3 className="text-sm font-semibold text-amber-00 mb-3">
        Tips for a successful listing
      </h3>
      <ul className="space-y-2">
        {tips.map((tip, i) => (
          <li key={i} className="flex items-start gap-2 text-sm text-black-700">
