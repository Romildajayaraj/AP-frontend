...
export const fetchAuctions = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get(`${API}/api/auction/show`);
...
export const fetchUserAndProducts = createAsyncThunk(
    ...
    async (userId, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get(`${API}/api/${userId}`);
            return response.data;
        } catch (error) {
...
export const fetchAuctionById = createAsyncThunk(
    ...
    async (productId, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get(`${API}/api/auction/${productId}`);
            return response.data;
        } catch (error) {
            return rejectWithValue(error.response?.data || "An unexpected error occurred.");
        }
